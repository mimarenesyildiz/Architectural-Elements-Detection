...
class FoodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        self.add_class("food", 1, "Wall")
        self.add_class("food", 2, "Door")
        self.add_class("food", 3, "GlassDoor")
        self.add_class("food", 4, "Window")
        self.add_class("food", 5, "Floor")
        self.add_class("food", 6, "Ceramic")
        self.add_class("food", 7, "Carpet")
